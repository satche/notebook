...
![Comparison between eulerian and hamiltonian graphs](euler-vs-hamilton.png)
...
- Find shortest path between 2 nodes
	- Bellman-Ford
	- [Dijkstra](../../../algorithms/graph/dijkstra/dijkstra.md) (positive weights only)
	- [Floyd-warshall](../../../algorithms/graph/floyd-warshall.md) (positive and negative, find shortest path for all nodes)
- Connect all vertices together with edges subsets ([Minimum Spanning Tree](../tree/tree.md#Minimum%20Spanning%20Tree))
	- [Prim](../../../algorithms/graph/prim/prim.md) (denses graphs)
	- [Kruskal](../../../algorithms/graph/kruskal/kruskal.md) (less denses graphs)