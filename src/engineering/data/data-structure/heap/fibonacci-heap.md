...
[Fibonacci heap](https://en.wikipedia.org/wiki/Fibonacci_heap) is a [heap](heap.md) [data-structure](../data-structure.md) that mimics the [fibonacci sequence](https://en.wikipedia.org/wiki/Fibonacci_sequence). It is very interesting to use to find [Minimum Spanning Tree](../tree/tree.md#Minimum%20Spanning%20Tree) and single source [shortest path](../../../algorithms/problems/shortest-path.md), like in [Dijkstra](../../../algorithms/graph/dijkstra/dijkstra.md) algorithm.
