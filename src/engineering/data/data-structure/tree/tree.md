...
A [tree](https://en.wikipedia.org/wiki/Tree_(data_structure)) is a hierarchical data structure close to a [graph](../graph/graph.md), with some constraints:
- It has a root node
...
![Example of a tree data structure](binary-tree.svg)
...
![Example of a Minimum Spanning Tree](minimum-spanning-tree.png)