...
RNNs have a better capacity to retain information over a sequence, Compared to [CNNs](cnn/cnn.md) which doesn't have explicit memory. It's also harder to parallelize, since each step of the sequence need to be computed before the next one.