...
[Transformer](https://en.wikipedia.org/wiki/Transformer_(deep_learning_architecture)) are [deep learning](deep learning.md) architectures mainly used for [NLP](../../applications/nlp.md), [LLMs](../llm.md) and other [generative AI](generative AI.md) tasks (e.g. image, sound, etc).
...
![Model of a Transformer architecture](transformers-architecture.png)

## Autoregression

An [autoregressive model](autoregressive model.md) will apply [regression](../../tasks/regression.md) (i.e. generate output according to inputs) based on its own previous generated output. 

## Models

### GPT

[Generative pre-trained transformer](Generative pre-trained transformer.md) (GPT) is a dominant architecture choice for a lot of [LLMs](../llm.md).
