...
- [Autoencoder](autoencoder/autoencoder.md): mainly used to discover and learn features from unlabeled data.
- [CNN](cnn/cnn.md): used in computer vision and image generation
- [RNN](rnn.md): used for sequential data (i.e. text, speech, time series)
- [Transformer](transformer/transformer.md): architecture made of 2 main parts, a *encoder* and a *decoder*
- [GAN](gan/gan.md): 2 neural networks (generator and discriminator) compete against each other
