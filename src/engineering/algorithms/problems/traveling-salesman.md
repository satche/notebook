...
It is easily transposable as a [graph](../../data/data-structure/graph/graph.md), where cities are vertices and routes are edges, representing a [hamiltonian path](../../data/data-structure/graph/graph.md#Eulerian%20vs.%20Hamiltonian).
