...
[Steiner tree problem](https://en.wikipedia.org/wiki/Steiner_tree_problem) can be see to the mix between a [Minimum Spanning Tree](../../data/data-structure/tree/tree.md#Minimum%20Spanning%20Tree) problem and a [shortest path](shortest-path.md) problem. It tries to find the shortest network between the vertices of a [graph](../../data/database/nosql/graph.md).
