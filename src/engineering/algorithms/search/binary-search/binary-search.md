...
![Example of binary search](binary-search.png)
...
A [binary search tree](https://en.wikipedia.org/wiki/Binary_search_tree) is like a [binary tree](../../../data/data-structure/tree/tree.md#Binary%20tree), but one child node is larger while the other is smaller than the parent node.
