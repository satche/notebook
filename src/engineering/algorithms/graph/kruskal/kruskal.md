...
[Kruskal's algorithm](https://wikipedia.org/wiki/kruskal%27s_algorithm) is a [greedy](../../algorithms.md#Terminology) algorithm that tries to find a [Minimum Spanning Tree](../../../data/data-structure/tree/tree.md#Minimum%20Spanning%20Tree) among a [graph](../../../data/data-structure/graph/graph.md). To achieve this, he use a minimal spanning forest first and connect the trees together.
...
Its behaviour is similar to [Prim's algorithm](../prim/prim.md), but it uses multiple trees before connecting them together.
