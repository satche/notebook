...
[Prim's algorithm](https://en.wikipedia.org/wiki/Prim%27s_algorithm) is a [greedy](../../algorithms.md#Terminology) algorithm used to find the [Minimum Spanning Tree](../../../data/data-structure/tree/tree.md#Minimum%20Spanning%20Tree) in a graph.
