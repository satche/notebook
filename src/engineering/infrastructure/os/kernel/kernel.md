...
![Diagram of OS architecture. The kernel is placed between the applications layer and the hardware layer, containing the CPU, Memory and Devices](kernel-layout.png)
